        ...
        http
            ...
            .authorizeHttpRequests(req ->
                req.requestMatchers(WHITE_LIST_URL)
                    .permitAll()
                    .requestMatchers(GET,"/api/v1/wishlist").hasAnyAuthority(USER.name())
                    .requestMatchers(POST,"/api/v1/wishlist/**").hasAnyAuthority(USER.name())
                    ...
                    .requestMatchers(GET, "/api/v1/appointments").hasAnyAuthority(USER.name(), ADMIN.name())
                    .requestMatchers(POST, "/api/v1/appointments/add").hasAnyAuthority(USER.name())
                    ...
                    .requestMatchers(DELETE, "/api/v1/news/{id}").hasAnyAuthority(ADMIN.name())
                    .requestMatchers(POST, "/api/v1/events/add").hasAnyAuthority(ADMIN.name())
                    .requestMatchers(DELETE, "/api/v1/events/{id}").hasAnyAuthority(ADMIN.name())
                    .anyRequest()
                    .authenticated()
            )
